...
class BehaveAgent:
    ...
    def finish_feature(
        self, context: Context, feature: Feature, status: Optional[str] = ..., **kwargs: Any
    ) -> None: ...
    def start_scenario(self, context: Context, scenario: Scenario, **kwargs: Any) -> None: ...
    def finish_scenario(
        self, context: Context, scenario: Scenario, status: Optional[str] = ..., **kwargs: Any
    ) -> None: ...
    def start_step(self, context: Context, step: Step, **kwargs: Any) -> None: ...
    def finish_step(self, context: Context, step: Step, **kwargs: Any) -> None: ...
    ...
    def _log_fixtures(self, item: Union[TagAndStatusStatement, TagStatement], item_type: str, parent_item_id: str): ...
    def _log_cleanups(self, context: Context, scope: str) -> None: ...
    def _finish_step_step_based(self, step: Step, status: Optional[str] = ..., **kwargs: Any) -> None: ...
